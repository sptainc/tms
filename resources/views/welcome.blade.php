    ...
    <div class="page-wrapper">
                ...
                <div class="container clearfix">
                    ...
                    <div class="logo-box clearfix">
                        <a class="navbar-brand" href="index.html">
                            <img src="/images/tms_logo.png" class="main-logo" width="97" alt="Awesome Image" />
                        </a>
        ...
        <section class="banner-one" id="home">
            <div class="container">
                <div class="banner-one__moc-wrap">
                    <img src="/images/banner-1-1.png" class="banner-one__moc" alt="Awesome Image" />
                </div><!-- /.banner-one__moc-wrap -->
                <div class="row justify-content-end">
                    <div class="col-lg-5 col-md-6">
                        <div class="banner-one__content">
                            <h3 class="banner-one__title">Awesome app <br> Showcase for <br> Businesses</h3>
                            <!-- /.banner-one__title -->
                            <p class="banner-one__text">Egestas magna ipsum vitae purus effic ipsum cubilia and laoreet
                                pretium ligula rutrum luctus.</p><!-- /.banner-one__text -->
                            <a href="#" class="banner-one__btn thm-btn">Discover more</a>
        ...
        <section class="brand-one">
            <div class="container">
                ...
                </div><!-- /.brand-one__carousel owl-theme owl-carousel -->
            </div><!-- /.container -->
        </section><!-- /.brand-one -->
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="service-one__single">
                            ...
                            <h3 class="service-one__title"><a href="#">High Creative<br>App Display</a></h3>
                            <!-- /.service-one__title -->
                            <p class="service-one__text">There are many variations of <br /> passages of lorem ipsum is
                                <br /> simply free text but majority <br> have suffered.</p><!-- /.service-one__text -->
                    ...
                    <div class="col-lg-4">
                        <div class="service-one__single">
                            ...
                            <h3 class="service-one__title"><a href="#">Unique and <br> custom options</a></h3>
                            <!-- /.service-one__title -->
                            <p class="service-one__text">There are many variations of <br /> passages of lorem ipsum is
                                <br /> simply free text but majority <br> have suffered.</p><!-- /.service-one__text -->
                        </div><!-- /.service-one__single -->
                    ...
                    <div class="col-lg-4">
                        <div class="service-one__single">
                            ...
                            <h3 class="service-one__title"><a href="#">secure <br> integration</a></h3>
                            <!-- /.service-one__title -->
                            <p class="service-one__text">There are many variations of <br /> passages of lorem ipsum is
                                <br /> simply free text but majority <br> have suffered.</p><!-- /.service-one__text -->
                        </div><!-- /.service-one__single -->
                    ...
                    <div class="col-lg-6">
                        <div class="cta-one__content">
                            <div class="block-title text-left">
                                <h2 class="block-title__title">Take a control on <br> your mobile app</h2>
                                <!-- /.block-title__title -->
                            </div><!-- /.block-title -->
                            <p class="cta-one__text">Duis aute irure dolor in reprehenderit in voluptate velit esse
                                cillum dolore eu fugiat nulla pariatur.</p><!-- /.cta-one__text -->
                            <ul class="cta-one__list">
                                <li class="cta-one__list-item"><i class="fa fa-check"></i>Refresing to get such a
                                    personal touch. </li><!-- /.cta-one__list-item -->
                                <li class="cta-one__list-item"><i class="fa fa-check"></i>Duis aute irure dolor in
                                    reprehenderit in voluptate.</li><!-- /.cta-one__list-item -->
                                <li class="cta-one__list-item"><i class="fa fa-check"></i>Velit esse cillum dolore eu
                                    fugiat nulla pariatur.</li><!-- /.cta-one__list-item -->
                            </ul><!-- /.cta-one__list -->
                        ...
                        <div class="pricing-one__single">
                            <div class="inner">
                                ...
                                <ul class="pricing-one__list">
                                    <li class="pricing-one__list-item">Extra features</li>
                                    <!-- /.pricing-one__list-item -->
                                    <li class="pricing-one__list-item">Lifetime free support</li>
                                    <!-- /.pricing-one__list-item -->
                                    <li class="pricing-one__list-item">Upgrate options</li>
                                    <!-- /.pricing-one__list-item -->
        ...
        <section class="testimonials-one">
            <img src="/images/shapes/testi-shape-1-1.png" class="testimonials-one__background-image"
                alt="Awesome Image" />
            <div class="container">
                <div class="row ">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-4">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                <span class="blog-one__meta">by <a href="#">admin</a> on <a href="#">july 27,
                                        2019</a></span>
                                <h3 class="blog-one__title"><a href="blog-details.html">Pre and post launch mobile app
                                        marketing pitfalls to avoid</a></h3><!-- /.blog-one__title -->
                                <p class="blog-one__text">There are many variations of passages of available but
                                    majority have alteration in some by inject humour or random words.</p>
                                <!-- /.blog-one__text -->
                    ...
                    <div class="col-lg-4">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                <span class="blog-one__meta">by <a href="#">admin</a> on <a href="#">july 27,
                                        2019</a></span>
                                <h3 class="blog-one__title"><a href="blog-details.html">Social currency high per-
                                        formance keywords or</a></h3><!-- /.blog-one__title -->
                                <p class="blog-one__text">There are many variations of passages of available but
                                    majority have alteration in some by inject humour or random words.</p>
                                <!-- /.blog-one__text -->
                            </div><!-- /.blog-one__content -->
                    ...
                    <div class="col-lg-4">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                <span class="blog-one__meta">by <a href="#">admin</a> on <a href="#">july 27,
                                        2019</a></span>
                                <h3 class="blog-one__title"><a href="blog-details.html">Prioritize these line items
                                        quarterly sales are at</a></h3><!-- /.blog-one__title -->
                                <p class="blog-one__text">There are many variations of passages of available but
                                    majority have alteration in some by inject humour or random words.</p>
                                <!-- /.blog-one__text -->
                            </div><!-- /.blog-one__content -->
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="footer-widget">
                                <a href="index.html" class="footer-widget__logo"><img src="/images/logo-1-1.png"
                                        width="132" alt="Awesome Image" /></a>
                                <p class="footer-widget__text">Lorem ipsum velna vitae auctor a congue magna tempor
                                    sapien eget gravida done.</p><!-- /.footer-widget__text -->
                            </div><!-- /.footer-widget -->
                        </div><!-- /.col-lg-5 -->
                        <div class="col-lg-4">
                            <div class="footer-widget">
            ...
            <div class="site-footer__bottom">
                <div class="container">
                    ...
                    <p class="site-footer__copy-text"><i class="fa fa-copyright"></i>copyright 2019 by <a
                            href="#">Layerdrops.com</a></p><!-- /.site-footer__copy-text -->
                </div><!-- /.container -->
